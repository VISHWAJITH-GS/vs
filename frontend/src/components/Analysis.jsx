...
const pageIds = ['overview', 'insights', 'opportunities', 'coach'];
...
function readPageFromHash() {
  ...
  return pageIds.includes(hash) ? hash : 'overview';
}
...
const Analysis = () => {
  ...
  useEffect(() => {
    const handleHashChange = () => setCurrentPage(readPageFromHash());
  ...
  const handleSendChat = async (message) => {
    ...
    try {
      ...
      setChatMessages((current) => [
        ...current,
        { role: 'assistant', content: 'The coach request failed. Please try again.' },
      ]);
    } finally {
      setIsChatting(false);
    }
    ...
    <div className="app-shell">
      ...
      <div className="container hero-layout">
        <header className="hero-panel glass-panel">
          <div className="hero-copy">
            ...
            <p className="glass-subtitle">
              The app is now split into page views so you can move through analysis, opportunities, and coaching without scrolling through one long screen.
            </p>
          </div>
        ...
        <section className="page-banner glass-panel">
          ...
          <p className="page-banner-copy">
            Overview keeps upload and resume parsing together. Insights focuses on quality scoring and gaps. Opportunities handles matches, salary, and saved revisions. Coach bundles rewrite and chat.
          </p>
        </section>
