...
const CoachPage = ({ rewrittenResume, onRewrite, loadingRewrite, messages, onSend, quickPrompts, loading }) => {
  return (
    <div className="page-stack">
      <RewritePanel rewrittenResume={rewrittenResume} onRewrite={onRewrite} loadingRewrite={loadingRewrite} />
